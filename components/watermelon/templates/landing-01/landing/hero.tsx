  ...
  const captureForm = (
    ...
    >
      <input
        ...
        className="h-12 flex-1 rounded-md border border-neutral-300 bg-neutral-100 px-5 text-sm text-neutral-900 shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] outline-none transition-colors placeholder:text-neutral-500 focus:border-[#FF6600] focus:bg-white focus:ring-2 focus:ring-[#FF6600]/20"
      />
      <button
        type="submit"
        className="h-12 shrink-0 rounded-md bg-[#FF6600] px-8 text-sm font-medium text-white shadow-[inset_0_2px_0_rgba(255,255,255,0.25),inset_0_-2px_0_rgba(0,0,0,0.18)] transition-colors hover:bg-[#e05a00]"
      >
        Find customers
      </button>
    </form>
