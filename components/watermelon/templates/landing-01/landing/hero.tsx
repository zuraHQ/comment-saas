  ...
  const captureForm = (
    ...
    >
      <input
        ...
        className="h-12 flex-1 rounded-md border border-neutral-300 bg-neutral-100 px-5 text-sm text-neutral-900 shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] outline-none transition-colors placeholder:text-neutral-500 focus:border-neutral-900 focus:bg-white focus:ring-2 focus:ring-neutral-900/10"
      />
      <button
        type="submit"
        className="h-12 shrink-0 rounded-md bg-neutral-900 px-8 text-sm font-medium text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.15)] transition-colors hover:bg-neutral-700"
      >
        Find customers
      </button>
    </form>
