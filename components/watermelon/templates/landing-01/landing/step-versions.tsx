...
const VARIANTS = [
  ...
  { key: "G", name: "Bento, wide ends", note: "First and last steps run full width with the preview beside the copy, the middle two sit half width. The section reads as one block rather than a list.", Render: VariantG },
  { key: "H", name: "Bento, hero tile", note: "Step one gets a tall tile and the rest fill in around it. Good if the first step is the one that sells.", Render: VariantH },
  { key: "I", name: "Four quarters", note: "Equal tiles, no hierarchy. Tightest vertically, and the easiest to scan.", Render: VariantI },
];
