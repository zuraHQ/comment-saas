    ...
    >
      <div className="container relative mx-auto px-4 md:px-8 lg:px-12 xl:px-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          {action ?? (
            <GetStartedDialog
              trigger={
                <button className="flex h-10 cursor-pointer items-center rounded-md bg-[#FF6600] px-6 text-xs font-bold tracking-widest text-white uppercase shadow-[inset_0_2px_0_rgba(255,255,255,0.25),inset_0_-2px_0_rgba(0,0,0,0.18)] transition-colors hover:bg-[#e05a00]">
                  Sign in
                </button>
              }
            />
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-neutral-200 shadow-lg p-4 flex flex-col gap-4 animate-fade-in-up">
          ...
          <GetStartedDialog
            trigger={
              <button className="mt-2 w-full cursor-pointer rounded-md bg-[#FF6600] px-4 py-4 text-center text-xs font-bold tracking-widest text-white uppercase shadow-[inset_0_2px_0_rgba(255,255,255,0.25),inset_0_-2px_0_rgba(0,0,0,0.18)] transition-colors hover:bg-[#e05a00]">
                Sign in
              </button>
            }
          />
